...
const MateriPramukaPage = () => {
  ...
  }, [touchStart, touchEnd, currentPage, totalPages, nextPage, prevPage]);
                    ...
                    >
                      ...
                      <div className="absolute top-3 left-3">
                        <motion.div
                          ...
                          } bg-gradient-to-r from-[#5c0b08] to-[#903d04] rounded-full flex items-center justify-center shadow-lg border-2 border-white/30`}
                        >
                          <span
            ...
            >
              ...
              >
                <motion.h2
                  ...
                  } font-bold text-[#5c0b08] leading-tight`}
                >
              ...
              >
                ...
                >
                  ...
                  {/* Fallback content */}
                  <div className="flex-col items-center justify-center hidden p-8 text-center text-gray-500">
                    <BookOpen
                      className={`${
