...
const Breadcrumb = () => {
  ...
  return (
    <div className="flex items-center space-x-2 text-sm text-yellow-800 bg-yellow-100 bg-opacity-50 rounded-full px-4 py-2">
      <Link to="/" className="hover:text-yellow-900 font-bold">
        Campfire
      </Link>
