      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        >
          <div className="inline-flex justify-center items-center p-4 mb-8 bg-white rounded-3xl shadow-xl shadow-orange-900/5 border border-orange-100">
            <Info className="w-10 h-10 text-[#903d04]" />
          </div>
          
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#5c0b08] mb-6 tracking-tight leading-tight">
            Fakta Jambore
          </h1>
          ...
          <p className="mx-auto max-w-2xl text-lg text-gray-600 leading-relaxed">
            Halaman ini sedang dalam pengembangan. Segera hadir berbagai fakta menarik dan sejarah mengenai kegiatan Jambore Nasional dan Dunia.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-500 max-w-sm leading-relaxed">
            Kami sedang mengumpulkan data dan fakta seru seputar sejarah pelaksanaan Jambore dari masa ke masa.
          </p>
        </motion.div>
      </div>
    </div>
